...
EOD;
	...
	static function insertTestData() {
		$sql = <<<EOD
INSERT INTO `events` (`title`, `start_year`, `end_year`, `details`) VALUES
('noch ein langes Ereignis &uuml;ber mehrere Jahre', 1940, 1944, '<p>Sieger Troph&auml;e / -Pokal mit Wunsch-Gravur - Der Pokal ist eines der beliebtesten Geburtstagsgeschenke f&uuml;r M&auml;nner und Frauen und l&auml;sst sich auch sehr gut zu runden Geburtstagen wie dem 30. 40. oder 50. Geburtstag verschenken.</p>'),
('Test-Event', 1952, 0, ''),
